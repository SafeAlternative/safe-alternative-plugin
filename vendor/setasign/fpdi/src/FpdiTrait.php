...
use SafeAlternative\setasign\Fpdi\PdfParser\CrossReference\CrossReferenceException;
use SafeAlternative\setasign\Fpdi\PdfParser\Filter\FilterException;
use SafeAlternative\setasign\Fpdi\PdfParser\PdfParser;
use SafeAlternative\setasign\Fpdi\PdfParser\PdfParserException;
use SafeAlternative\setasign\Fpdi\PdfParser\StreamReader;
use SafeAlternative\setasign\Fpdi\PdfParser\Type\PdfArray;
use SafeAlternative\setasign\Fpdi\PdfParser\Type\PdfBoolean;
use SafeAlternative\setasign\Fpdi\PdfParser\Type\PdfDictionary;
use SafeAlternative\setasign\Fpdi\PdfParser\Type\PdfHexString;
use SafeAlternative\setasign\Fpdi\PdfParser\Type\PdfIndirectObject;
use SafeAlternative\setasign\Fpdi\PdfParser\Type\PdfIndirectObjectReference;
use SafeAlternative\setasign\Fpdi\PdfParser\Type\PdfName;
use SafeAlternative\setasign\Fpdi\PdfParser\Type\PdfNull;
use SafeAlternative\setasign\Fpdi\PdfParser\Type\PdfNumeric;
use SafeAlternative\setasign\Fpdi\PdfParser\Type\PdfStream;
use SafeAlternative\setasign\Fpdi\PdfParser\Type\PdfString;
use SafeAlternative\setasign\Fpdi\PdfParser\Type\PdfToken;
use SafeAlternative\setasign\Fpdi\PdfParser\Type\PdfType;
use SafeAlternative\setasign\Fpdi\PdfParser\Type\PdfTypeException;
use SafeAlternative\setasign\Fpdi\PdfReader\PageBoundaries;
use SafeAlternative\setasign\Fpdi\PdfReader\PdfReader;
use SafeAlternative\setasign\Fpdi\PdfReader\PdfReaderException;
use SafeAlternative\setasign\FpdiPdfParser\PdfParser\PdfParser as FpdiPdfParser;
/**
 * The FpdiTrait
 *
