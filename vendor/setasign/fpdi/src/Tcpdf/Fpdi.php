 ...
 */
namespace SafeAlternative\setasign\Fpdi\Tcpdf;

use SafeAlternative\setasign\Fpdi\FpdiTrait;
use SafeAlternative\setasign\Fpdi\PdfParser\CrossReference\CrossReferenceException;
use SafeAlternative\setasign\Fpdi\PdfParser\Filter\AsciiHex;
 ...
 */
class Fpdi extends \SafeAlternative\TCPDF
{
    use FpdiTrait {
    ...
    protected function writePdfType(PdfType $value)
    {
        ...
        if ($value instanceof PdfString) {
            ...
            $value->value = \SafeAlternative\TCPDF_STATIC::_escape($string);
