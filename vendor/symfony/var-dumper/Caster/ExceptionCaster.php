 ...
 */
namespace SafeAlternative\Symfony\Component\VarDumper\Caster;

use SafeAlternative\Symfony\Component\ErrorHandler\Exception\SilencedErrorContext;
use SafeAlternative\Symfony\Component\VarDumper\Cloner\Stub;
        ...
        if (isset($f['file'], $f['line'])) {
            ...
            if (isset(self::$framesCache[$cacheKey])) {
                ...
                if (\is_file($f['file']) && 0 <= self::$srcContext) {
                    if (!empty($f['class']) && (\is_subclass_of($f['class'], 'SafeAlternative\\Twig\\Template') || \is_subclass_of($f['class'], 'SafeAlternative\\Twig_Template')) && \method_exists($f['class'], 'getDebugInfo')) {
