...
namespace SafeAlternative\Sameday\PersistentData;
...
class PersistentDataFactory
{
    ...
    public static function createPersistentDataHandler($handler)
    {
        ...
        throw new InvalidArgumentException('SafeAlternative\\The persistent data handler must be set to "session", "memory", or be an instance of Sameday\\PersistentData\\PersistentDataInterface');
    }
}
