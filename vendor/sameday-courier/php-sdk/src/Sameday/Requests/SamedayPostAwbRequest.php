...
use SafeAlternative\Sameday\Http\RequestBodyUrlEncoded;
use SafeAlternative\Sameday\Http\SamedayRequest;
use SafeAlternative\Sameday\Objects\ParcelDimensionsObject;
use SafeAlternative\Sameday\Objects\PostAwb\Request\AwbRecipientEntityObject;
use SafeAlternative\Sameday\Objects\PostAwb\Request\ThirdPartyPickupEntityObject;
use SafeAlternative\Sameday\Objects\Types\AwbPaymentType;
use SafeAlternative\Sameday\Objects\Types\CodCollectorType;
use SafeAlternative\Sameday\Objects\Types\DeliveryIntervalServiceType;
...
class SamedayPostAwbRequest implements SamedayRequestInterface
{
     ...
     */
    public function __construct($pickupPointId, $contactPersonId, PackageType $packageType, array $parcelsDimensions, $serviceId, AwbPaymentType $awbPayment, AwbRecipientEntityObject $awbRecipient, $insuredValue, $cashOnDeliveryAmount = 0.0, CodCollectorType $cashOnDeliveryCollector = null, ThirdPartyPickupEntityObject $thirdPartyPickup = null, array $serviceTaxIds = [], DeliveryIntervalServiceType $deliveryIntervalServiceType = null, $reference = null, $observation = null, $priceObservation = null, $clientObservation = null, $lockerId = null)
    {
