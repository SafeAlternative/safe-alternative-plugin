...
namespace SafeAlternative\Sameday\Objects\Locker;
...
class LockerObject
{
     ...
     */
    public function __construct($id, $name, $county, $city, $address, $postalCode, $lat, $long, $phone, $email, array $boxes, array $schedule)
    {
        $this->id = $id;
        $this->name = $name;
        $this->county = $county;
