...
namespace SafeAlternative\Sameday\Objects\PostAwb\Request;

use SafeAlternative\Sameday\Objects\Types\PersonType;
/**
 * Entity.
 *
 * @package Sameday
...
class EntityObject
{
     ...
     */
    public function __construct($city, $county, $address, $name, $phone, CompanyEntityObject $company = null)
    {
        $this->city = $city;
        $this->county = $county;
