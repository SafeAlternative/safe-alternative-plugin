...
namespace SafeAlternative\Sameday\HttpClients;

use SafeAlternative\GuzzleHttp\Client;
...
class HttpClientsFactory
{
    ...
    public static function createHttpClient($handler)
    {
        ...
        if ('guzzle' === $handler) {
            if (!\class_exists('SafeAlternative\\GuzzleHttp\\Client')) {
        ...
        throw new InvalidArgumentException('SafeAlternative\\The http client handler must be set to "curl", "stream", "guzzle", be an instance of GuzzleHttp\\Client or an instance of Sameday\\HttpClients\\SamedayHttpClientInterface');
    }
    /**
