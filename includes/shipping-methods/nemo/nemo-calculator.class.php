...
final class SafealternativeNemoShippingClass
{
    private $curl, $api_url;

    public function __construct()
    {
        $this->api_url = 'https://app.nemoexpress.ro/nemo/API/get_price?';
        $this->curl = curl_init();
    ...
    public function calculate(array $parameters): ?float
    {
        ...
        } else throw new Exception('Can not calculate Nemo shipping: ' . json_encode($result));
