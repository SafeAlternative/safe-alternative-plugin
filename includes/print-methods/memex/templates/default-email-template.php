...
<br/>
Comanda dumneavoastra cu numarul: [nr_comanda] din data de [data_comanda] a fost expediata prin serviciu de curierat Memex si este in curs de livrare.
<br/>
Nota de transport (AWB-ul) are numarul [nr_awb] si poate fi urmarita aici: <a href="https://memex.ro/urmareste-livrarea" target="_blank">Status comanda</a>
<br/>
...
<br/>
Daca nu sunteti contactat in maximum 2 zile lucratoare de la plasarea comenzii, va rog sa contactati compania Memex la telefon 0720.800.353.
<br/>
...
add_option('memex_email_template', $default_template);
register_setting('memex-plugin-settings', 'memex_email_template');