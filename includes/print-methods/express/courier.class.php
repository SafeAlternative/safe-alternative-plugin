...
final class SafealternativeExpressClass
{
    private $curl, $api_url;

    public function __construct()
    {
        $this->api_url = SAFEALTERNATIVE_API_URL .'/v1/shipping/express/';
        $this->curl = curl_init();
    ...
    {
        $this->api_url = "http://app.curiermanager.ro/cscourier/API/list_services?";
        $parameters = [
            'api_key' => get_option('express_key'),
