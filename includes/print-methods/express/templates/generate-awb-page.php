...
<style>    
    .admin_page_generate-awb-express table.form-table, p.submit { width: 100%; max-width: 775px; }
    .admin_page_generate-awb-express input, .admin_page_generate-awb-express select, .admin_page_generate-awb-express textarea { width: 100%; }
    .admin_page_generate-awb-express .form-table td { padding: 0; }
    .admin_page_generate-awb-express .form-table th { padding: 15px 10px 15px 0; }
    .admin_page_generate-awb-express .select2-container { width: 100% !important; }
</style>

<div class="wrap">
<h2>Genereaza AWB Express</h2>
<br/>
            ...
            <tr>
                ...
                <td>
                    <select name="awb[service_135]">
                        <option value="true" <?= $_POST['awb']['service_135'] == 'true' ? 'selected' : '' ?> >Da</option>
                        <option value="false" <?= $_POST['awb']['service_135'] == 'false' ? 'selected' : '' ?> >Nu</option>
                    </select>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>
                    <select name="awb[service_134]">
                        <option value="true" <?= $_POST['awb']['service_134'] == 'true' ? 'selected' : '' ?> >Da</option>
                        <option value="false" <?= $_POST['awb']['service_134'] == 'false' ? 'selected' : '' ?> >Nu</option>
                    </select>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>
                    <select name="awb[service_136]">
                        <option value="true" <?= $_POST['awb']['service_136'] == 'true' ? 'selected' : '' ?> >Da</option>
                        <option value="false" <?= $_POST['awb']['service_136'] == 'false' ? 'selected' : '' ?> >Nu</option>
                    </select>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>
                    <select name="awb[service_137]">
                        <option value="true" <?= $_POST['awb']['service_137'] == 'true' ? 'selected' : '' ?> >Da</option>
                        <option value="false" <?= $_POST['awb']['service_137'] == 'false' ? 'selected' : '' ?> >Nu</option>
                    </select>
                </td>
            </tr>
...
<p class="submit" style="text-align: center;">© Copyright <script>document.write(new Date().getFullYear());</script> | Un sistem prietenos de generare AWB-uri Express creat de <a href="https://safe-alternative.ro/" target="_blank">SafeAlternative</a></p>
</div>
